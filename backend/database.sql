...
CREATE TABLE IF NOT EXISTS usuarios (
    ...
    rol ENUM('admin', 'usuario', 'operario') NOT NULL DEFAULT 'usuario',
...
('Silo de Maiz', 'silo', 'kg', 40000, 25000, 5000),
('Bolson de Maiz', 'bolson', 'kg', 10000, 8500, 2000),
('Fardo de Alfalfa', 'fardo', 'kg', 5000, 4200, 1000),
('Sales Minerales', 'sales', 'kg', 4000, 2000, 500);
...
('Lote B - Terneros', 'Ternero', 20, 50.00, 'Lote de terneros jovenes');
...
-- Parametros nutricionales de referencia (valores de planilla del nutricionista)
-- Estos valores se pueden ajustar desde la interfaz de dietas
